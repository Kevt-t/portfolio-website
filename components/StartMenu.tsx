    ...
    <AnimatePresence>
      {isStartMenuOpen && (
        <motion.div
          ...
          className="fixed bottom-14 sm:bottom-16 left-1/2 w-[calc(100%-2rem)] sm:w-[480px] md:w-[540px] max-h-[calc(100vh-6rem)] sm:max-h-[600px] bg-white/90 dark:bg-gray-900/90 backdrop-blur-win11 rounded-win11 win11-shadow border border-gray-200/50 dark:border-gray-700/50 overflow-y-auto mobile-hide-scrollbar z-40"
        >
          {/* Search Bar */}
